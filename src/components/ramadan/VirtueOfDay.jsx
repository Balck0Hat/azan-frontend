...
export default function VirtueOfDay({ todayVirtue }) {
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12 }}
      ...
      <p className="text-[var(--text-primary)] font-bold text-center mb-3">✨ فضيلة اليوم</p>
      <p className="text-[var(--text-primary)] text-center leading-relaxed text-lg mb-2">{todayVirtue.text}</p>
